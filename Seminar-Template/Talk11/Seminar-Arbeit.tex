...
\vspace{-1em}
	...
	\vspace{-1em}
		...
		\begin{figure}[ht]
		    ...
		    \end{center}
		    \caption{Pattern Card \cite{gassmann55}}
...
\vspace{-1em}
	...
	\vspace{-1em}	
		...
		\begin{figure}[ht]
		    ...
		    \end{center}
		    \caption{Chan's business model framework applied to the HKC use case \cite{chan}}
		    \label{fig:chan_ex}
		\end{figure}
...
\vspace{-1em}
	...
	\vspace{-1em}
			...
			%\begin{minipage}{0.47\textwidth}
			             ...
			             \vspace{0.2cm}
			                         %\scalebox{.75}{
			\begin{tabular}{c@{\quad}c@{\quad}c@{\quad}c@{\quad}c@{\quad}c@{\quad}c@{\quad}c} \hline
			\rule{0pt}{8pt}
