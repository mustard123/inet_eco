...
\label{sec:bmf_comparison}
	...
	\begin{figure}[ht]
	    \begin{center}
	    \includegraphics[scale=0.6]{Talk11/chanexample.jpg}
	    \end{center}
...
\label{sec:summary}
 ...
 \begin{thebibliography}{99}
	 ...
	 \bibitem {gassmann55} Gassmann et al.: \emph{Gesch?smodelle entwickeln: 55 innovative Konzepte mit dem St. Galler Business Model Navigator.} in Hanser Verlag, 2013.
