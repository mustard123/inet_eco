...
\section{Business Model Frameworks}
	...
	\subsection{Definitions}
	 ...
	 A \textbf{Business Model Framework} is a tool to help a company in the development of its business model by presenting an overview over the business model components described above[ju].
	\begin{itemize}
		\item Definitions
...
\section{Summary and Conclusions}
	...
	% \end{itemize}
	 ...
	 \begin{thebibliography}{99}
 		 ...
 		 \bibitem {gassmann55} Gassmann et al.: \emph{Gesch�ftsmodelle entwickeln: 55 innovative Konzepte mit dem St. Galler Business Model Navigator.} in Hanser Verlag, 2013.

 		 \bititem {osterwalder} A. Osterwalder, Y. Pigneur, A. Smith: \emph{Business Model Generation}, self published, 2010.
